...
namespace LibraryManagementSystem.Interfaces
{
    public interface IBorrowService
    {
        ...
        Task<LibrarianReviewResponseDto> ReviewReturnByLibrarianAsync(LibrarianReviewRequestDto request);

        Task<ReturnVerificationResponseDto> VerifyReturnAsync(ReturnVerificationRequestDto request);
    }
}